...
**If you already have Bitcoin Knots and DATUM installed and just want to know what the various settings do, skip to #configuring-bitcoin and #configuring-datum**
